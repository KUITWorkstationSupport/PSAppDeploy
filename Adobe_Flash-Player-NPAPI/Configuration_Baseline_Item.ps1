...
#v1.1 by Calvin Schulte 03/2018. Stronger typing for versions. True/False are now legit boolean instead of just strings.
...
$appNameAlt = "Adobe Flash Player * Plugin" #The REALLY old Flash NPAPI was called "Plugin", so look for this too.
