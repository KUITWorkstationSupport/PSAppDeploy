...
Try {
	...
	[string]$appName = 'Air'
	[string]$appVersion = '29.0.0.112'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '03/15/2018'
	[string]$appScriptAuthor = 'Calvin Schulte'
	##*===============================================
	## Variables: Install Titles (Only set here to override defaults set by the toolkit)
	[string]$installName = 'Adobe Air 28.0.0.127'
	[string]$installTitle = 'Adobe Air 28.0.0.127' # Displays to the user in boxes
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CheckDiskSpace -PersistPrompt -MinimizeWindows $False
        ...
        Execute-Process -Path 'AdobeAIRInstaller.exe' -Parameters '-silent'
